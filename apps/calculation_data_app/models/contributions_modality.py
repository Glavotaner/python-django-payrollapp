...
class ContributionsModality(models.Model):
    ...
    pension_fund_ind = models.FloatField(
        verbose_name= _('Pension fund - individual'), default=0.05, help_text = _('Legal rate for the individual pension fund. Expressed as a decimal number'))

    health_insurance = models.FloatField(
        verbose_name= _('Health fund'), default=0.165, help_text = _('Legal rate for the health insurance fund. Expressed as a decimal number'))
