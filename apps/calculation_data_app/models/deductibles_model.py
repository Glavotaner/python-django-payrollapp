...
class DeductiblesModel(models.Model):
    ...
    second_child = models.FloatField(verbose_name=_('Second child'),default=1.0)
    third_child = models.FloatField(verbose_name=_('Third child'),default=1.4)
    fourth_child = models.FloatField(verbose_name=_('Fourth child'),default=1.9)
    ...
    valid_from = models.DateTimeField(
        verbose_name=_('Valid from'), default = date.today())
