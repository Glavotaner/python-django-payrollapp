...
from .. import person_validation, id_validators, general_validation 
...
class TestValidation(TestCase):
    ...
    def test_invalid_oib(self):        
        self.assertRaisesMessage(ValidationError, 'PID is invalid, please check your input', id_validators.validate_pid, "38263212112")

    def test_oib_length_short(self):        
        self.assertRaisesMessage(ValidationError, 'PID is of an invalid length', id_validators.validate_pid, "3826321211")

    def test_oib_length_long(self):
        self.assertRaisesMessage(ValidationError, 'PID is of an invalid length', id_validators.validate_pid, "382632121123")

    def test_oib_numeric_text(self):        
        self.assertRaisesMessage(ValidationError, 'PID is not entirely numeric', id_validators.validate_pid, "382632121A3")

    def test_oib_numeric_space(self):
        self.assertRaisesMessage(ValidationError, 'PID is not entirely numeric', id_validators.validate_pid, "382632121 3")
